...
export const metadata = { title: "Claim your card — Visa Wallet Rating" };

export default function ClaimPage() {
  return (
    <div className="mx-auto max-w-4xl px-5 pt-20 pb-10 text-center">
      <h1 className="text-4xl font-bold tracking-tight">Your card already exists.</h1>
      ...
      <p className="mt-6 text-muted leading-relaxed max-w-lg mx-auto">
        Every rated wallet has a Visa Wallet Rating credential waiting — built from its real history, soulbound to
        the wallet, portable only by your signature. Browse the sample cards, then preview your own.
      </p>
      ...
      <div className="mt-14 grid gap-6 sm:grid-cols-3 text-left">
        {[
          ...
          { n: "3", t: "Claim", d: "Your card becomes a soulbound credential on Base, refreshed as you transact." },
        ].map((s) => (
